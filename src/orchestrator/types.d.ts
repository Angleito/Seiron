...
export type UserIntentType = 'lending' | 'liquidity' | 'portfolio' | 'trading' | 'analysis' | 'info' | 'risk';
...
export type AgentType = 'lending_agent' | 'liquidity_agent' | 'portfolio_agent' | 'risk_agent' | 'analysis_agent';
...
export type AgentMessageType = 'task_request' | 'task_response' | 'health_check' | 'status_update' | 'error_report' | 'capability_update';
...
export type LoadBalancingStrategy = 'round_robin' | 'least_connections' | 'weighted_response_time' | 'capability_based';
...
export type OrchestratorEvent = IntentReceivedEvent | TaskStartedEvent | TaskCompletedEvent | AgentStatusChangedEvent | ErrorOccurredEvent;
