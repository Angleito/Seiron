...
export const productionDefaults = {
  ...
  MCP_HIVE_TIMEOUT: '30000',
  MCP_HIVE_RETRY_ATTEMPTS: '3',
  MCP_HIVE_RETRY_DELAY: '1000',
  MCP_SEI_TIMEOUT: '30000',
  MCP_SEI_RETRY_ATTEMPTS: '3',
  MCP_SEI_RETRY_DELAY: '1000',
  MCP_PORTFOLIO_TIMEOUT: '30000',
  MCP_PORTFOLIO_RETRY_ATTEMPTS: '3',
  MCP_PORTFOLIO_RETRY_DELAY: '1000'
};
